...
| 用户研究证据包 | `docs/user-research-plan.md`, `docs/user-interview-summary.md`, `materials/evidence/scoring-evidence-map.md` | 已建模板 | `USER_RESEARCH_EVIDENCE_METRIC 8/8`；真实访谈、问卷和应用价值定量结果仍为 `待采集`，不得编造 |
...
- 发布证据索引集中列出 `LANDING_RELEASE_CANDIDATE_METRIC 63/63`、`REAL_WORLD_READY_METRIC 22/22`、`CLOUD_DEVICE_PREP_METRIC 5/5`、`CLOUD_DEVICE_PREP_MISSING_VIDEOS 9/9`、`CLOUD_BACKEND_PREFLIGHT_METRIC`、`CLOUD_DEVICE_PACKAGE_METRIC 30/30`、`ANDROID16_REAL_IMPLEMENTATION_GUIDE_METRIC 12/12`、`IMAGE_SEMANTIC_CASES_METRIC 9/9`、`BACKEND_AUDIT_LOG_METRIC 8/8`、`LIVE_SMOKE_EVIDENCE_METRIC 7/7`、`RELEASE_HANDOFF_CHECKS_METRIC 24/24`、`RELEASE_EVIDENCE_INDEX_METRIC 10/10`、`DELIVERABLES_METRIC 10/10`、`NO_DEFAULT_IMAGE_UPLOAD_METRIC 12/12`、`ANDROID_IMAGE_PREPROCESS_METRIC 15/15`、BlueLM 脱敏日志、`REQUIREMENT_MATRIX_METRIC 9/9`、`validation/traceability.md` SHIKE-070、`docs/optimization-log.md` 当前交接摘要、strict 云真机阻断项和重跑命令。
...
- 用户研究证据包用于回答“应用价值”评分项：`docs/user-research-plan.md` 定义 10 人样本和指标，`docs/user-interview-summary.md` 保持 `待采集` 模板状态，`materials/evidence/scoring-evidence-map.md` 将应用价值缺口接到 `USER_RESEARCH_EVIDENCE_METRIC 8/8`；不得把计划当成真实访谈结论。
