...
def main() -> int:
    ...
    checks = [
        ...
        ("editable_time_present", "draftTime" in android_source and ("只改时间" in android_source or "Text(\"时间\")" in android_source)),
        ("editable_location_present", "draftLocation" in android_source and ("只改地点" in android_source or "Text(\"地点\")" in android_source)),
        ("editable_status_present", "draftStatus" in android_source and ("Text(\"状态\")" in android_source or "ReviewEditTarget.All" in android_source)),
