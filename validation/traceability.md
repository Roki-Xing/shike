...
| Issue | 交付物 | 主要验收文件 |
|---|---|---|
| SHIKE-000 | 交付边界与评分映射 | `docs/delivery-boundary-and-scoring.md` |
| SHIKE-010 | MVP 范围收敛表 | `docs/mvp-scope.md` |
| SHIKE-020 | 产品规格与差异化说明 | `docs/product-spec.md` |
| SHIKE-030 | 初赛高保真原型关键页面 | `prototype/high-fidelity-prototype.md`, `prototype/index.html` |
