...
| `python3 shike/validation/validate_android_unit_tests.py` | PASS | `ANDROID_UNIT_TEST_METRIC 86/86` |
...
- The real-world readiness validator now keeps the README mechanical acceptance entry tied to `validate_android_structure.py`, `validate_android_unit_tests.py`, `ANDROID_STRUCTURE_METRIC 31/31`, and `ANDROID_UNIT_TEST_METRIC 86/86`.
